...
(:requirements :equality :negative-preconditions :typing)
	...
	:effect 
		(and
		(and (not (closed level_1_0)) (tile-at-pos ?t ?x ?to_y level_1_0) (is-blank ?x ?y level_1_0) (not (tile-at-pos ?t ?x ?y level_1_0)) (not (is-blank ?x ?to_y level_1_0)) )
		(not-in-move-up) 
		(not (copied-pos-move-up level_0_0)) 
		(not (copied-neg-move-up level_0_0)) 
		)
