...
public class Domain implements Serializable {
	 ...
	 * @return <code>true</code> if the derived predicate was added; <code>false</code>
	 *         otherwise.
	 * @throws NullPointerException if the specified predicate is null.
	 */
	 ...
	 * @return <code>true</code> if the specified symbol is a declared type; <code>false</code>
	 *         otherwise.
	 */
	 ...
	 * @return the type from a specified symbol or <code>null</code> if no type with this symbol
	 *         was declared.
	 */
	 ...
	 * @return <code>true</code> if the specified symbol is a declared constant; <code>false</code>
	 *         otherwise.
	 */
	 ...
	 *         the class <code>PlDomain</code> and has the same name; <code>false</code>
	 *         otherwise.
	 */
