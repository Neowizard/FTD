...
public class Symbol implements Serializable {
	...
	public Symbol(final Symbol symbol) {
		if (symbol == null) throw new NullPointerException("symbol == null");
	...
	public Symbol(final Kind kind, final Token token) throws NullPointerException {
		if (token == null || kind == null) throw new NullPointerException();
		this.kind = kind;
	...
	public Symbol(final Kind kind, final String image, final int beginLine, final int beginColumn,
		...
		if (image == null || kind == null) throw new NullPointerException();
		this.kind = kind;
	...
	public final String renameVariables(final Map<String, String> context) {
		...
		if (this.getKind().equals(Symbol.Kind.VARIABLE)) {
			...
			if (newImage != null) this.setImage(newImage);
		}
		return image;
	}
	 ...
	 *         is not null and of kind <tt>Symbol</tt> and it has the same image; otherwise return
	 *         <tt>false</tt>.
