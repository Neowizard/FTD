...
public class Lexer implements LexerConstants {
    ...
    private File file;
        ...
        if (expectedSeq) {
                ...
                retval += "\u005cnWas expecting:" + "\u005cn" + "    ";
                } else {
                retval += "\u005cnWas expecting one of:" + "\u005cn" + "    ";
                }
  ...
  final public Set<RequireKey> require_key() throws ParseException {
    ...
    case ADL:
      ...
      break;
    case NON_DETERMINISTIC:
      jj_consume_token(NON_DETERMINISTIC);
                        requirements.add(RequireKey.NON_DETERMINISTIC);
      break;
    case ACTION_COSTS:
...
//			}
  ...
  final public List<Symbol> function_type() throws ParseException {
    ...
    if (jj_2_15(2) && (this.isRequirement(RequireKey.NUMERIC_FLUENTS)
    ...
    } else if (jj_2_16(2) && (this.isRequirement(RequireKey.OBJECT_FLUENTS) || this.isRequirement(RequireKey.FLUENTS))) {
      token = jj_consume_token(OBJECT_TYPE);
                        typesList.add(new Symbol(Symbol.Kind.TYPE, token));
                        {if (true) return typesList;}
    } else if (jj_2_17(2) && (this.isRequirement(RequireKey.OBJECT_FLUENTS) || this.isRequirement(RequireKey.FLUENTS))) {
      left_bracket();
      jj_consume_token(EITHER);
      label_9:
      while (true) {
        symbol = primitive_type();
                                typesList.add(symbol);
        if (jj_2_14(2)) {
          ;
        } else {
          break label_9;
  ...
  final public Exp node() throws ParseException {
    ...
    if (jj_2_31(2)) {
      ...
      node = and_gd();
    } else if (jj_2_33(2) && (this.isRequirement(RequireKey.DISJUNCTIVE_PRECONDITIONS))) {
      node = or_gd();
    } else if (jj_2_34(2) && (this.isRequirement(RequireKey.NEGATIVE_PRECONDITIONS))) {
      node = not_gd();
    } else if (jj_2_35(2) && (this.isRequirement(RequireKey.DISJUNCTIVE_PRECONDITIONS)
                                    && this.isRequirement(RequireKey.NEGATIVE_PRECONDITIONS))) {
      node = imply_gd();
    } else if (jj_2_36(2) && (this.isRequirement(RequireKey.EXISTENTIAL_PRECONDITIONS))) {
      node = exists_gd();
    } else if (jj_2_37(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_gd();
    } else if (jj_2_38(3) && (this.isRequirement(RequireKey.EQUALITY))) {
      node = equal_gd();
    } else if (jj_2_39(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = f_comp();
    } else {
...
}
{
  ...
  final public void structure_def() throws ParseException {
    ...
    } else if (jj_2_61(2) && (this.isRequirement(RequireKey.DURATIVE_ACTIONS))) {
      op = durative_action_def();
                                this.domain.addOperator(op);
    } else if (jj_2_62(2) && (this.isRequirement(RequireKey.DERIVED_PREDICATES))) {
      dp = derived_def();
  ...
  final public Exp pre_gd() throws ParseException {
        Exp node = null;
    if (jj_2_63(3) && (this.isRequirement(RequireKey.PREFERENCES))) {
      node = pref_gd();
    } else if (jj_2_64(2)) {
      node = and_pre_gd();
    } else if (jj_2_65(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pre_gd();
    } else if (jj_2_66(2)) {
      node = empty_or();
    } else if (jj_2_67(2)) {
  ...
  final public Exp oneof_c_effect() throws ParseException {
        Exp node = new Exp(Connective.ONEOF);
        Exp s = null;
    left_bracket();
  ...
  final public Exp c_effect() throws ParseException {
        Exp node = null;
    if (jj_2_74(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_effect();
    } else if (jj_2_75(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
  ...
  final public Exp p_effect() throws ParseException {
        Exp node = null;
    if (jj_2_80(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = assign_op();
    } else if (jj_2_81(2) && (this.isRequirement(RequireKey.ACTION_COSTS))) {
  ...
  final public Exp duration_constraint() throws ParseException {
    ...
    if (jj_2_89(2)) {
      node = empty_or();
    } else if (jj_2_90(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
  ...
  final public Exp d_op() throws ParseException {
    ...
    if (jj_2_97(2)) {
      node = equal_d_op();
    } else if (jj_2_98(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = gequal_d_op();
    } else if (jj_2_99(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = lequal_d_op();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp d_value() throws ParseException {
    ...
    if (jj_2_100(2)) {
      node = number();
    } else if (jj_2_101(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = f_exp();
    } else {
  ...
  final public Exp da_gd() throws ParseException {
    ...
    if (jj_2_102(2)) {
      ...
      node = and_da_gd();
    } else if (jj_2_104(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_da_gd();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp pref_timed_gd() throws ParseException {
    ...
    if (jj_2_106(2)) {
      node = timed_gd();
    } else if (jj_2_107(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
  ...
  final public Exp da_effect() throws ParseException {
    ...
    if (jj_2_112(2)) {
      ...
      node = timed_effect();
    } else if (jj_2_114(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_da_effect();
    } else if (jj_2_115(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = when_da_effect();
    } else if (jj_2_116(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = da_assign_op();
    } else {
  ...
  final public Exp timed_effect() throws ParseException {
    ...
    if (jj_2_133(2)) {
      node = at_a_effect();
    } else if (jj_2_134(3) && (this.isRequirement(RequireKey.CONTINOUS_EFFECTS))) {
      node = assign_op_t();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public void problem() throws ParseException {
    ...
    try {
      ...
      init();
      goal();
      if (jj_2_172(2) && (this.isRequirement(RequireKey.CONSTRAINTS))) {
  ...
  final public Exp init_el() throws ParseException {
        Exp node = null;
    if (jj_2_175(3) && (this.isRequirement(RequireKey.TIMED_INITIAL_LITERALS))) {
      node = timed_literal();
    } else if (jj_2_176(2)) {
      node = literal(Lexer.CONSTANT);
    } else if (jj_2_177(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS)
                            || this.isRequirement(RequireKey.ACTION_COSTS))) {
      node = equal_init_el();
  ...
  final public Exp pref_con_gd() throws ParseException {
    ...
    } else if (jj_2_179(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pref_con_gd();
    } else if (jj_2_180(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
  ...
  private boolean jj_3R_105() {
    ...
    jj_semLA = this.isRequirement(RequireKey.DURATION_INEQUALITIES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_99()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_64() {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.OBJECT_FLUENTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_39()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_125() {
    ...
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_134()) return true;
    }
    return false;
  }
  ...
  private boolean jj_3R_135() {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.OBJECT_FLUENTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_116()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_35() {
    ...
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_62()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_114() {
    ...
    jj_semLA = this.isRequirement(RequireKey.PREFERENCES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_107()) return true;
    }
    return false;
  }
  ...
  private boolean jj_3R_117() {
    ...
    jj_semLA = this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_104()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_154() {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.ACTION_COSTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_177()) return true;
    }
    }
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x2000,0x0,0x0,0x2000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x3fffff80,0x3fffff80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0xf0000000,0x0,0x0,0x0,0xf0000000,0xf0000000,0x0,0x40,0xf0000000,0xf0000000,0xf0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0xb00,0x800,0x400,0xb00,0xb00,0x800,0x800,0x804,0x0,0x800,0xc00,0xc00,0x1000,0x804,0x800,0x1000,0x800,0x800,0x1002,};
   }
  final private JJCalls[] jj_2_rtns = new JJCalls[198];
