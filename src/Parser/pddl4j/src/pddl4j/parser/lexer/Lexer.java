...
}
{
  ...
  final public Exp c_effect() throws ParseException {
        Exp node = null;
    if (jj_2_72(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_effect();
    } else if (jj_2_73(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
  ...
  final public Exp p_effect() throws ParseException {
        Exp node = null;
    if (jj_2_78(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = assign_op();
    } else if (jj_2_79(2) && (this.isRequirement(RequireKey.ACTION_COSTS))) {
  ...
  final public Exp duration_constraint() throws ParseException {
    ...
    if (jj_2_87(2)) {
      node = empty_or();
    } else if (jj_2_88(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
  ...
  final public Exp d_op() throws ParseException {
    ...
    if (jj_2_95(2)) {
      node = equal_d_op();
    } else if (jj_2_96(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = gequal_d_op();
    } else if (jj_2_97(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = lequal_d_op();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp d_value() throws ParseException {
    ...
    if (jj_2_98(2)) {
      node = number();
    } else if (jj_2_99(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = f_exp();
    } else {
  ...
  final public Exp da_gd() throws ParseException {
    ...
    if (jj_2_100(2)) {
      ...
      node = and_da_gd();
    } else if (jj_2_102(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_da_gd();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp pref_timed_gd() throws ParseException {
    ...
    if (jj_2_104(2)) {
      node = timed_gd();
    } else if (jj_2_105(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
  ...
  final public Exp da_effect() throws ParseException {
    ...
    if (jj_2_110(2)) {
      ...
      node = timed_effect();
    } else if (jj_2_112(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_da_effect();
    } else if (jj_2_113(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = when_da_effect();
    } else if (jj_2_114(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = da_assign_op();
    } else {
  ...
  final public Exp timed_effect() throws ParseException {
    ...
    if (jj_2_131(2)) {
      node = at_a_effect();
    } else if (jj_2_132(3) && (this.isRequirement(RequireKey.CONTINOUS_EFFECTS))) {
      node = assign_op_t();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  final public Exp f_exp_da() throws ParseException {
    ...
    if (jj_2_151(2)) {
      node = da_op();
    } else if (jj_2_152(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = var_duration();
    } else if (jj_2_153(2)) {
      node = f_exp();
    } else {
  ...
  final public void problem() throws ParseException {
    ...
    try {
      ...
      init();
      goal();
      if (jj_2_170(2) && (this.isRequirement(RequireKey.CONSTRAINTS))) {
  ...
  final public Exp init_el() throws ParseException {
        Exp node = null;
    if (jj_2_173(3) && (this.isRequirement(RequireKey.TIMED_INITIAL_LITERALS))) {
      node = timed_literal();
    } else if (jj_2_174(2)) {
      node = literal(Lexer.CONSTANT);
    } else if (jj_2_175(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS)
                            || this.isRequirement(RequireKey.ACTION_COSTS))) {
      node = equal_init_el();
  ...
  final public Exp pref_con_gd() throws ParseException {
    ...
    } else if (jj_2_177(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pref_con_gd();
    } else if (jj_2_178(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
  ...
  private boolean jj_3R_103() {
    ...
    jj_semLA = this.isRequirement(RequireKey.DURATION_INEQUALITIES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_97()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_133() {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.OBJECT_FLUENTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_114()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_112() {
    ...
    jj_semLA = this.isRequirement(RequireKey.PREFERENCES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_105()) return true;
    }
    return false;
  }
  ...
  private boolean jj_3R_115() {
    ...
    jj_semLA = this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_102()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_152() {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.ACTION_COSTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_175()) return true;
    }
    }
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1fffff80,0x1fffff80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x3c000000,0x0,0x0,0x0,0x3c000000,0x3c000000,0x0,0x20,0x3c000000,0x3c000000,0x3c000000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x2c0,0x200,0x100,0x2c0,0x2c0,0x200,0x200,0x201,0x0,0x200,0x300,0x300,0x400,0x201,0x200,0x400,0x200,0x200,0x400,};
   }
  final private JJCalls[] jj_2_rtns = new JJCalls[196];
